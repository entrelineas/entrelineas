                ...
                userServices.create(req.body, function(err, user){
                    if(err){
                        ...
                        let mailOptions = {
                            ...
                            html:  'Gracias por tu Registro, <a href="http://localhost:8080/x/v1/user/token?email='+user.local.email+'&token='+user.local.token+'">Dale click para activar tu cuenta</a>'          // texto
                        };
